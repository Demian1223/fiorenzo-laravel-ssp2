<x-app-layout>
    <x-admin-hero title="Edit Product" image="Manage_Inventory.jpg" />
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="image_url" id="image_url"
                                    ...
                                    class="mt-2 block w-full border-gray-300 focus:border-[#8b0000] focus:ring-[#8b0000] shadow-sm font-sans">
                                <p class="text-sm text-gray-500 mt-1 font-sans">Enter absolute URL or path relative
                                    to
                                    public/.</p>
                    ...
                    <div class="mt-8 font-['Cormorant_Garamond']">
                        ...
                        <textarea name="description" id="description" rows="4"
                            class="mt-2 block w-full border-gray-300 focus:border-[#8b0000] focus:ring-[#8b0000] shadow-sm font-sans">{{ old('description', $product->description) }}</textarea>
