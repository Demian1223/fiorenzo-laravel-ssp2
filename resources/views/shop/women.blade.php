<x-app-layout>
    ...
    <section class="relative h-screen w-full overflow-hidden bg-[#8b0000]">
        ...
        <div class="absolute inset-0">
            ...
            <video src="{{ asset('videos/Valentine_Women.mp4') }}" autoplay muted loop playsinline
        ...
        <div class="absolute inset-0 z-20 flex flex-col justify-end items-start
           text-white px-8 md:px-16 pb-24 md:pb-48 text-left font-serif">
            <p class="text-xs md:text-sm uppercase tracking-[0.3em] mb-4 opacity-90">This Valentine’s JENNIE</p>
            <h2 class="text-5xl md:text-6xl font-light tracking-wide mb-6">Women</h2>
        ...
        <div class="max-w-[1920px] mx-auto px-6 lg:px-12 py-6 text-center">
            <nav
                ...
                @foreach($categories as $category)
                    <a href="{{ route('shop.women', ['category' => $category->slug]) }}"
    ...
    <main class="max-w-[1920px] mx-auto px-6 lg:px-12 py-10 font-serif">
        <livewire:product-listing gender="women" :categorySlug="request('category')" />
    </main>
